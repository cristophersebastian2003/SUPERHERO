...
-- Primero, verifica si el procedimiento almacenado ya existe y elimínalo si es necesario
DROP PROCEDURE IF EXISTS sp_publisher_listar;

-- Delimitador necesario para cambiar el delimitador por defecto
DELIMITER //

-- Crea el procedimiento almacenado
CREATE PROCEDURE sp_publisher_listar()
BEGIN
  -- Consulta para obtener la lista de editores
  SELECT id, publisher_name FROM superhero.publisher;
END //
...
CREATE PROCEDURE spu_superhero_listar()
BEGIN
  SELECT
    id,
    superhero_name,
...
CALL spu_superhero_listar();

DELIMITER //
CREATE PROCEDURE spu_superhero_listar_por_editor(IN editor_id INT)
BEGIN
    SELECT * FROM superhero
    WHERE publisher_id = editor_id;
END //
DELIMITER ;
